...
class CreateDB:
    ...
    def __init__(self):
        self.RPATH = str(pathlib.Path(__file__).parent.absolute()).rpartition('\\')[0]
        db_path = self.RPATH + "\\src\\basecamp.db"
    ...
    def config_schema(self):
        ...
        query = """ CREATE TABLE IF NOT EXISTS bcamp_config (
                        ...
                        ui_sidebar_location TEXT NOT NULL,
                        ui_render_sidebar TEXT NOT NULL, 
                        ui_caseviewer_search_location TEXT NOT NULL,
                        ui_render_sidebar_search TEXT NOT NULL,
